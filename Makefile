...
# Generated by qmake (2.01a) (Qt 4.4.3) on: Thu Nov 6 23:16:08 2008
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/battlezone1.0.0/ && $(COPY_FILE) --parents main.h config.h network.h .tmp/battlezone1.0.0/ && $(COPY_FILE) --parents main.cpp config.cpp .tmp/battlezone1.0.0/ && (cd `dirname .tmp/battlezone1.0.0` && $(TAR) battlezone1.0.0.tar battlezone1.0.0 && $(COMPRESS) battlezone1.0.0.tar) && $(MOVE) `dirname .tmp/battlezone1.0.0`/battlezone1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/battlezone1.0.0
